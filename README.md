...
- Folder "captured_data": Contains the jsonl files created for the State Machine executions. These are the foundation for the graphical illustrations at the end in the Jupyter Notebook.
